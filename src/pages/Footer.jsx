...
const Footer = () => {
  ...
  return (
    ...
    <div className=' max-w-screen-2xl container bg-black h-auto text-white py-20 flex md:flex-row flex-col gap-5 justify-around items-center '>
        ...
        className='h-auto w-80 border-2 border-gray-400 bg-gray-900 flex p-2 flex-col  md:mb-0 mb-10 text-justify '>
        ...
        <motion.div 
          initial={{opcacity:0, translateX: "-100%"}}
           whileInView={{opcacity:1, translateX: 0}}
           transition={{duration:1}}
        className='h-96 w-80 border-2 border-gray-400  bg-gray-900 text-start flex flex-col gap-3 '>
        ...
        initial={{opcacity:0, translateX: "100%"}}
           whileInView={{opcacity:1, translateX: 0}}
           transition={{duration:1}}
         className='md:h-96 h-80 w-80 border-2 bg-gray-900 border-gray-400 flex flex-col gap-3 '>
