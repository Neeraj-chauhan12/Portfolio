...
const Portfolio = () => {
  ...
  const Frontend = [
    {
      ...
      name: "To-Do List App",
      description:
        "Feature-rich task management application with local storage",
    ...
    },
    {
      ...
      description:
        "A school management application with student and teacher features",
    ...
    },
    {
      ...
      description:
        "A restaurant management application with menu and order features",
  ...
  const data = [
...

    {
      ...
      bt1: "https://interview-ai-resume.onrender.com",
      bt2: "https://github.com/Neeraj-chauhan12/Interview-ai-resume",
    },
  ];
  ...
  return (
    <div className="max-w-screen-2xl mx-auto h-auto bg-gray-900 text-white py-20 px-5 md:px-8">
      ...
      <div>
        ...
        >
          {Frontend.map(({ id, img, name, description, bt1, bt2 }) => (
            <motion.div
              key={id}
            ...
            >
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-xl md:text-2xl font-bold mb-2 group-hover:text-blue-400 transition">
                  {name}
                </h3>
